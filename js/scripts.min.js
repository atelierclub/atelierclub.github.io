...
var swiper=new Swiper(".collection-slider",{slidesPerView:1,autoHeight:!0,navigation:{nextEl:".collection .swiper-button-next",prevEl:".collection .swiper-button-prev"},pagination:{el:".collection .swiper-pagination",clickable:!0}}),swiper=new Swiper(".experience-slider",{slidesPerView:4,freeMode:!0,pagination:{el:".experience .swiper-pagination",clickable:!0},breakpoints:{30:{slidesPerView:1},650:{slidesPerView:2},769:{slidesPerView:3},1120:{slidesPerView:4}}});$(document).ready(function(){$(".header-bar").on("click",function(){$(".header").toggleClass("header-active")}),$(".accordeon .accordeon-block").hide().prev().click(function(){$(this).parents(".accordeon").hasClass("accordeon-active")?$(".accordeon").removeClass("accordeon-active"):($(".accordeon").removeClass("accordeon-active"),$(this).parents(".accordeon").addClass("accordeon-active")),$(this).parents().find(".accordeon-block").not(this).slideUp().prev(),$(this).next().not(":visible").slideDown().prev().parents()})});